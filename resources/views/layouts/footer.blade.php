    ...
    <div class="container py-13 py-md-15">
        <div class="row gy-6 gy-lg-0">
            <div class="col-md-4 col-lg-3">
                <div class="widget">
                    <img class="mb-4" src="{{ asset('theme/assets/img/logo-light.png') }}"
                        srcset="{{ asset('theme/assets/img/logo-light@2x.png') }}" alt="" />
...
{{-- App scripts --}}
<script src="{{ asset('app/dist/js/vendor.auto.min.js') }}"></script>
</body>
