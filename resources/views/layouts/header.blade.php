...
<head>
    ...
    <link rel="preload" href="{{ asset('theme/assets/img/favicon.png') }}" as="style"
        onload="this.rel='stylesheet'">
    <link rel="preload" href="{{ asset('theme/assets/css/plugins.css') }}" as="style"
        onload="this.rel='stylesheet'">
    <link rel="preload" href="{{ asset('theme/assets/css/style.css') }}" as="style" onload="this.rel='stylesheet'">
    <link rel="preload" href="{{ asset('theme/assets/css/colors/purple.css') }}" as="style"
        onload="this.rel='stylesheet'">
    <link rel="preload" href="{{ asset('theme/assets/css/fonts/thicccboi.css') }}" as="style"
        onload="this.rel='stylesheet'">
    <link rel="stylesheet" href="{{ asset('app/dist/css/vendor.auto.min.css') }}">
            ...
            {{-- <div class="alert bg-primary text-white fade show rounded-0 mb-1 text-center" role="alert">
                <div class="container">
                    <div class="alert-inner d-flex justify-content-center align-items-center p-0">
                        <span class="badge badge-lg bg-white text-primary text-uppercase rounded me-2">Update
                            3.2.1</span>Updated to Bootstrap v5.2.0!
                    </div>
                    <!-- /.alert-inner -->
                </div>
                <!-- /.container -->
            ...
            <nav class="navbar navbar-expand-lg center-nav transparent navbar-light">
                <div class="container flex-lg-row flex-nowrap align-items-center">
                    <div class="navbar-brand w-100">
                        <a href="{{ route('home') }}">
                            <img src="{{ asset('theme/assets/img/logo-purple.png') }}"
                                srcset="{{ asset('theme/assets/img/logo-purple@2x.png') }}" alt="" />
                        </a>
                    </div>
                                            ...
                                            <ul class="row row-cols-1 row-cols-lg-6 gx-0 gx-lg-4 gy-lg-2 list-unstyled">
                                                <li class="col"><a class="dropdown-item" href="./demo1.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi1.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo2.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi2.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo3.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi3.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo4.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi4.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo5.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi5.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo6.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi6.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo7.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi7.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo8.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi8.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo9.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi9.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo10.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi10.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo11.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi11.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo12.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi12.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo13.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi13.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo14.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi14.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo15.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi15.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo16.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi16.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo17.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi17.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo18.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi18.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo19.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi19.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo20.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi20.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo21.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi21.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo22.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi22.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo23.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi23.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo24.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi24.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo25.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi25.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo26.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi26.jpg') }}"
                                                ...
                                                <li class="col"><a class="dropdown-item" href="./demo27.html">
                                                        <figure class="rounded lift d-none d-lg-block"><img
                                                                src="{{ asset('theme/assets/img/demos/mi27.jpg') }}"
                                            ...
                                            <ul
                                                ...
                                                <li class="col"><a class="dropdown-item"
                                                        ...
                                                        <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2">
                                                            <img class="rounded-0"
                                                                src="{{ asset('theme/assets/img/demos/block1.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>About</span>
                                                    </a>
                                                ...
                                                <li class="col"><a class="dropdown-item"
                                                        ...
                                                        <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2">
                                                            <img class="rounded-0"
                                                                src="{{ asset('theme/assets/img/demos/block2.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>Blog</span>
                                                    </a>
                                                ...
                                                <li class="col"><a class="dropdown-item"
                                                        ...
                                                        <div class="rounded img-svg')}} d-none d-lg-block p-4 mb-lg-2">
                                                            <img class="rounded-0"
                                                                src="{{ asset('theme/assets/img/demos/block3.svg') }}"
                                                                alt="">
                                                        </div>
                                                ...
                                                <li class="col"><a class="dropdown-item"
                                                        ...
                                                        <div class="rounded img-svg')}} d-none d-lg-block p-4 mb-lg-2">
                                                            <img class="rounded-0"
                                                                src="{{ asset('theme/assets/img/demos/block4.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>Clients</span>
                                                    </a>
                                                ...
                                                <li class="col"><a class="dropdown-item"
                                                        ...
                                                        <div class="rounded img-svg')}} d-none d-lg-block p-4 mb-lg-2">
                                                            <img class="rounded-0"
                                                                src="{{ asset('theme/assets/img/demos/block5.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>Contact</span>
                                                    </a>
                                                ...
                                                <li class="col"><a class="dropdown-item"
                                                        ...
                                                        <div class="rounded img-svg')}} d-none d-lg-block p-4 mb-lg-2">
                                                            <img class="rounded-0"
                                                                src="{{ asset('theme/assets/img/demos/block6.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>Facts</span>
                                                    </a>
                                                ...
                                                <li class="col"><a class="dropdown-item"
                                                        ...
                                                        <div class="rounded img-svg')}} d-none d-lg-block p-4 mb-lg-2">
                                                            <img class="rounded-0"
                                                                src="{{ asset('theme/assets/img/demos/block7.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>FAQ</span>
                                                    </a>
                                                ...
                                                <li class="col"><a class="dropdown-item"
                                                        ...
                                                        <div class="rounded img-svg')}} d-none d-lg-block p-4 mb-lg-2">
                                                            <img class="rounded-0"
                                                                src="{{ asset('theme/assets/img/demos/block8.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>Features</span>
                                                    </a>
                                                ...
                                                <li class="col"><a class="dropdown-item"
                                                        ...
                                                        <div class="rounded img-svg')}} d-none d-lg-block p-4 mb-lg-2">
                                                            <img class="rounded-0"
                                                                src="{{ asset('theme/assets/img/demos/block9.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>Footer</span>
                                                    </a>
                                                ...
                                                <li class="col"><a class="dropdown-item"
                                                        ...
                                                        <div class="rounded img-svg')}} d-none d-lg-block p-4 mb-lg-2">
                                                            <img class="rounded-0"
                                                                src="{{ asset('theme/assets/img/demos/block10.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>Hero</span>
                                                    </a>
                                                ...
                                                <li class="col"><a class="dropdown-item"
                                                        ...
                                                        <div class="rounded img-svg')}} d-none d-lg-block p-4 mb-lg-2">
                                                            <img class="rounded-0"
                                                                src="{{ asset('theme/assets/img/demos/block17.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>Misc</span>
                                                    </a>
                                                ...
                                                <li class="col"><a class="dropdown-item"
                                                        ...
                                                        <div class="rounded img-svg')}} d-none d-lg-block p-4 mb-lg-2">
                                                            <img class="rounded-0"
                                                                src="{{ asset('theme/assets/img/demos/block11.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>Navbar</span>
                                                    </a>
                                                ...
                                                <li class="col"><a class="dropdown-item"
                                                        ...
                                                        <div class="rounded img-svg')}} d-none d-lg-block p-4 mb-lg-2">
                                                            <img class="rounded-0"
                                                                src="{{ asset('theme/assets/img/demos/block12.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>Portfolio</span>
                                                    </a>
                                                ...
                                                <li class="col"><a class="dropdown-item"
                                                        ...
                                                        <div class="rounded img-svg')}} d-none d-lg-block p-4 mb-lg-2">
                                                            <img class="rounded-0"
                                                                src="{{ asset('theme/assets/img/demos/block13.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>Pricing</span>
                                                    </a>
                                                ...
                                                <li class="col"><a class="dropdown-item"
                                                        ...
                                                        <div class="rounded img-svg')}} d-none d-lg-block p-4 mb-lg-2">
                                                            <img class="rounded-0"
                                                                src="{{ asset('theme/assets/img/demos/block14.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>Process</span>
                                                    </a>
                                                ...
                                                <li class="col"><a class="dropdown-item"
                                                        ...
                                                        <div class="rounded img-svg')}} d-none d-lg-block p-4 mb-lg-2">
                                                            <img class="rounded-0"
                                                                src="{{ asset('theme/assets/img/demos/block15.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>Team</span>
                                                    </a>
                                                ...
                                                <li class="col"><a class="dropdown-item"
                                                        ...
                                                        <div class="rounded img-svg')}} d-none d-lg-block p-4 mb-lg-2">
                                                            <img class="rounded-0"
                                                                src="{{ asset('theme/assets/img/demos/block16.svg') }}"
                                                                alt="">
                                                        </div>
                    ...
                    <div class="navbar-other w-100 d-flex ms-auto">
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item d-none d-md-block">
                                <a href="{{ route('shop') }}" class="btn btn-primary rounded-pill">Purchase Now</a>
                            </li>
